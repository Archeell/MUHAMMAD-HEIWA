1. UPDATE siswa SET tempatlahir="INDRAMAYU" WHERE nis="12002406";

2. SELECT * FROM siswa WHERE nis="12002822";

3. UPDATE siswa SET tanggallahir="2005-05-05", alamat="CIGADUNG" WHERE nis="12002406";
...
7. SELECT * FROM siswa WHERE tanggallahir BETWEEN "2004-10-01" AND "2004-12-30";
...
14. SELECT * FROM siswa WHERE nilai BETWEEN "80" AND "90" ORDER BY nilai ASC;
	SELECT * FROM siswa WHERE nilai BETWEEN "80" AND "90" ORDER BY nilai DESC;

15. DELETE FROM siswa WHERE nis="12002406";

16. SELECT tempatlahir FROM siswa GROUP BY tempatlahir;

17. SELECT nama, kelas, nilai FROM siswa;
